...
### Re-exports
Re-exports are covered in [Rust Guide 14.3.1. Re-Exporting APIs with `pub use`](https://someb1oody.github.io/RustGuide/en/Chapter-14/14.3/14.3._Re-Exporting_APIs_with_Pub_Use.html).
...
It is usually better to wrap the external type in a newtype (see [Rust Guide 19.2.6. Using the Newtype Pattern to Implement an External Trait on an External Type](https://someb1oody.github.io/RustGuide/en/Chapter-19/19.2/19.2._Advanced_Traits.html)) and expose only the parts of the external type that you consider useful.
