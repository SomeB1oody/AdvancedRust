...
The `Copy` trait changes the semantics of moving a value of a given type (see [1.9.2. How to Implement the `Copy` Trait](../../Chapter-01/1.9/1.9._Ownership_(Quick_Recap)_-_Core_Ideas_of_Ownership,_How_to_Implement_Copy_Trait,_Value_Drop,_and_Drop_Order.md)). Example:
```rust
