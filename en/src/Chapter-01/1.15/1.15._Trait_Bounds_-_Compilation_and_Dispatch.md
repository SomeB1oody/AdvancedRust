...
The compiler copies part of the type or function for each `T` (for each concrete type), so that each type has its own function. This process is called **monomorphization** (see [Rust Guide 10.2.6. Performance of Generic Code](https://someb1oody.github.io/RustGuide/en/Chapter-10/10.2/10.2._Generics.html)). (Calling methods on a `dyn Trait` is different: that uses *dynamic dispatch*, covered later in this article; see [Rust Guide 17.2.3. Trait Objects Use Dynamic Dispatch](https://someb1oody.github.io/RustGuide/en/Chapter-17/17.2/17.2._Using_Trait_Objects_to_Store_Values_of_Different_Types.html).)
