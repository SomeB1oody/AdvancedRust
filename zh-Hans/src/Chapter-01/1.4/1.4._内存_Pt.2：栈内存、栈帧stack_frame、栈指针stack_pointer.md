...
## 1.4.2. 栈内存(stack)
有这么一个公理，叫做：“有疑问时，首选Stack”。但是如果想把数据放在栈内存，编译器就必须知道类型的大小。换句话说：“有疑问时，首选实现了Sized的类型”（关于Sized trait的详细内容见[【Rust指南】19.5.4. 动态大小类型与`Sized` trait](https://someb1oody.github.io/RustGuide/zh-Hans/Chapter-19/19.5/19.5._高级类型.html)）。
